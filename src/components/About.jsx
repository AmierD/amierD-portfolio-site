...
import '../App.css'
import headshotPhoto from '../assets/headshotPhoto.jpg'
                ...
                <div className="about-content">
                    ...
                    <div className="about-text-container">
                        <div className="about-text">
                            <p>
                            Amier Davis is a student at Hampton University studying Computer Science
                        ...
                        <div className="about-text"> 
                            <p>
                            This past summer, Amier had the opportunity to be a Software Developer Intern at
                        ...
                        <div className="about-text"> 
                            <p>
                            Outside of school and work, Amier enjoys creating content and music, taking 
